README für Chess(Stub)

Dieses Projekt dient als Einstieg in die Implementierungsaufgabe (HA2 SWTPP WS 2016/2017). 
...
---| GameServer
   ...
   ---| src
      ...
      ---| de.tuberlin.sese.swtpp.gameserver.model.lasca
         Packet für die Entity-Klassen des Klassenmodells, d.h. das Datenmodell des konkreten Spiels Lasca
         
      ---| de.tuberlin.sese.swtpp.gameserver.lasca
         Hier befinden sich die jUnit Testcases und Testsuiten, die von euch anzupassen sind.
         
      ---| de.tuberlin.sese.swtpp.gameserver.swtpp.chess.web
...
für den Client-Browser) ist auch bereits erledigt. Das Gleiche gilt für die Server-Verwaltung, das abstrakte Spiel und einen großen Teil des Lasca-Spiels. Für euch bleibt nur die Implementierung einiger 
Funktionen in der LascaGame und die dazugehörigen Tests. Bestehender Code darf nicht geändert werden. 
...
ausgeführt werden kann. Kern davon ist das Servlet (in unserem Fall ChessServlet), diese Klasse implementiert die Klasse HttpServlet 
...
an das Servlet, welches wiederum mit den geforderten Daten antwortet soll. Kern der Anwendung sind die Bibliotheken von chessboardjs.com (angepasst an Lasca), welches uns das Spielbrett liefert.